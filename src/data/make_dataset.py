...
def main(input_filepath, output_filepath):
    ...
    input_filepath= click.prompt('Enter the file path for the input data (e.g., ./data/raw)', type=click.Path(exists=True))
    ...
    output_filepath = click.prompt('Enter the file path for the output processed data (e.g., ./data/processed)', type=click.Path())
